    ...
    <>
      <style>
        ...
        <div style={{ borderBottom: '1px solid #2f2f2f' }}>
          <h2 style={{ marginLeft: '10%', marginRight: '10%', marginTop:'15px' }} ><strong>{restaurant.title}</strong></h2>
          <p style={{ marginLeft: '10%', marginRight: '10%' }}>{restaurant.description}</p>
          <Row style={{ marginTop: '10px', marginBottom: '10px', marginLeft: '10%', marginRight: '10%', alignItems: 'center' }}>
            <Col>
              ...
              <span style={{ marginLeft: '10px' }}>{restaurant.location}</span>
            </Col>
          </Row>
          <br />
