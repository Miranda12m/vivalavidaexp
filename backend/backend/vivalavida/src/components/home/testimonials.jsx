...
export default function Testimonials() {
  return (
    <>
      ...
      .carousel-item img:not(.exclude-from-carousel) {
        /* Estilos para imágenes en el carousel, excluyendo la clase 'exclude-from-carousel' */
        width: 150 !important;
        height: 150 !important;
        filer: brightness(1) !important;
                  ...
                  <MDBCol lg="4" className="mb-5 mb-md-0">
                    <div className="d-flex justify-content-center mb-4">
                      <img
                        ...
                        className="rounded-circle shadow-1-strong exclude-from-carousel"
